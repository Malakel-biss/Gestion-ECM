...
export function SignIn() {
  ...
  const handleSignIn = async (e) => {
    ...
    try {
      ...
      if (response.data && response.data.roles.length > 0) {
    ...
    <section className="m-8 flex gap-4">
      <div className="w-full lg:w-3/5 mt-24">
        <div className="text-center">
          ...
          <Typography variant="paragraph" color="blue-gray" className="text-lg font-normal">Entrez votre email et mot de passe</Typography>
        </div>
        <form className="mt-8 mb-2 mx-auto w-80 max-w-screen-lg lg:w-1/2">
          ...
          /> */}
          {/* <Link to="/dashboard/home" className="text-blue-gray-500 hover:underline">Mot de passe oublié?
        ...
        Se connecter
          ...
          <Typography variant="paragraph" className="text-center text-blue-gray-500 font-medium mt-4">
            Vous étes encore un candidat?
            <Link to="/auth/sign-up" color='red' className="text-gray-900 ml-1">Déposer Demande Candidature</Link>
          </Typography>
        </form>
