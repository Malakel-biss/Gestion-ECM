...
public class Professeur {
    ...
    public Professeur(String p_nom, String p_prenom, String p_adresse, String p_codePostal, String p_ville, String p_suite, String p_qualite, Date p_datenaissance, Date date_embauche, Date date_depart, String p_telephone_domicile, String p_telephone_ecole) {
        this.pnom = p_nom;
    ...
    public Professeur(Long p_id, String p_nom, String p_prenom, String p_adresse, String p_codePostal, String p_ville, String p_suite, String p_qualite, Date p_datenaissance, Date date_embauche, Date date_depart, String p_telephone_domicile, String p_telephone_ecole) {
        this.pid = p_id;
        this.pnom = p_nom;
        this.pprenom = p_prenom;
        this.padresse = p_adresse;
